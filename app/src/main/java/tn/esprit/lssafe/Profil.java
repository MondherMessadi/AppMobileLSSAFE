...
public class Profil extends AppCompatActivity {
    ...
    private TextView greetingTextView ,fullNameTextView ,serialTextView,emailTextView , stat,edit;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final TextView serialTextView =findViewById(R.id.serial);
